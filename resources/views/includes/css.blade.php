<!-- CDN of JQuery Datatables -->
<link rel="stylesheet" href="{{ asset('assets/plugins/bootstrap.css') }}">
<link rel="stylesheet" href="{{ asset('assets/plugins/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/plugins/responsive.bootstrap4.min.css') }}">
